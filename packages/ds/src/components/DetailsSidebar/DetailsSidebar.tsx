  ...
  return (
    <DsCard className="room__details-sidebar">
        ...
        <div className="room__details-row">
          <span className="room__details-icon room__details-icon--host" aria-hidden="true">
            {hostAvatarUrl ? (
              ...
              <span className="room__details-host-initials">{getInitials(hostName)}</span>
            )}
          </span>
      ...
      <div className="room__details-actions">
        <button type="button" className="room__details-btn room__details-btn--primary" onClick={onCopyCode}>
          <CopyIcon size={15} />
          {copied ? 'Copied!' : 'Copy Code'}
        </button>
        <button type="button" className="room__details-btn room__details-btn--share" onClick={onShareLink}>
          <LinkIcon size={15} />
          Share Link
        </button>
      </div>
